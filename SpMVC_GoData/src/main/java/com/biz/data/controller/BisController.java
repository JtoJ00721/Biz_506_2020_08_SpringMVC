...
public class BisController {
	...
	public String station(@RequestParam(name = "station", required = false, defaultValue = "") String station,
			Model model) {
	...
	@ResponseBody
	@RequestMapping(value = "/busstop", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
