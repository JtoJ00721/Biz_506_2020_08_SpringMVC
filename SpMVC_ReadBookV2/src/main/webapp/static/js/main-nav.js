$(function () {
  ...
  $("#main-nav li").click(function () {
    ...
    if (menu_text === "도서정보") {
      ...
      // document.location.href = rootPath + "/books"; 도 가능
      ...
      $.ajax({
        ...
        // post 방식으로 요청을 해야한다.
        // post 방식으로 ajax 요청을 할때 보안경고가 뜨고
        // 서버가 거부하는 현상이 발생한다.
        // spring security 서버는 POST 방식으로 요청을 할때
        // csrf_token값을 건내주어야 한다.
        // spring form tag를 사용할때는 문제가 없는데
